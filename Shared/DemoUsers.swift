...
extension UserCredentials {
    ...
    static let esun = Self(
        id: "esun",
        name: "Edward Sun",
        avatarURL: URL(string: "https://as2.ftcdn.net/v2/jpg/03/13/48/11/1000_F_313481184_w1MksVAEvnhHg3vFDSnlRaIZAfDNOg6B.jpg")!,
        token: .development(userId: "esun"),
        birthLand: "Earth"
    )

    static let dculligan = Self(
        id: "dculligan",
        name: "Duffy Culligan",
        avatarURL: URL(string: "https://t3.ftcdn.net/jpg/03/72/28/04/360_F_372280438_7q6MJ1ftxPAwcnZOdyvj7vOOUo04lZxj.jpg")!,
        token: .development(userId: "dculligan"),
        birthLand: "Earth"
    )

    static let rcoppola = Self(
        id: "rcoppola",
        name: "Roman Coppola",
        avatarURL: URL(string: "https://t3.ftcdn.net/jpg/03/98/50/34/360_F_398503463_zUIYTwt0gyUtRGE4i8iMFu64rOZMRTNG.jpg")!,
        token: .development(userId: "rcoppola"),
        birthLand: "France"
    )

    static let jsoyinka = Self(
        id: "jsoyinka",
        name: "Jarele Soyinka",
        avatarURL: URL(string: "https://as1.ftcdn.net/v2/jpg/03/97/29/00/1000_F_397290052_wm43JsJdX97l09lWUujXN1TYGIUYxXGk.jpg")!,
        token: .development(userId: "jsoyinka"),
        birthLand: "Atlanta"
    )
    static let test = Self(
        id: "test",
        name: "Test Bot",
        avatarURL: URL(string: "https://bit.ly/2TIt8NR")!,
        token: .development(userId: "test"),
        birthLand: "Mars"
    )
